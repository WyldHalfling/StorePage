        ...
        <div class="small-12 medium-11">
            <div class="grid-x grid-padding-x">
                ...
                <div class="small-12 column">
                    ...
                    <input class="button success float-right" type="button" value="Save Product">
                </div> 
            </div>
        </div>
    </form>
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Phil\Desktop\StorePage\resources\views/admin/product/create.blade.php ENDPATH**/ ?>